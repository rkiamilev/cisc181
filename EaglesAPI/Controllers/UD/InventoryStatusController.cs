...
namespace EaglesAPI.Controllers.UD
{
    ...
    public class InventoryStatusController : ControllerBase
    {
        ...
        {
          if (_context.InventoryStatuses == null)
          {
              return NotFound();
          }
        ...
        public async Task<ActionResult<InventoryStatus>> PostInventoryStatus(InventoryStatus inventoryStatus)
        {
          if (_context.InventoryStatuses == null)
          {
              return Problem("Entity set 'EaglesOracleContext.InventoryStatuses'  is null.");
          }
        ...
        {
            return (_context.InventoryStatuses?.Any(e => e.InventoryStatusId == id)).GetValueOrDefault();
        }
    }
}
