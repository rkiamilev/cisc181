...
public partial class InventoryAttrVal
{
    ...
    [Column("INVENTORY_ATTR_VAL_PRODUCT_ATTR_VAL_ID")]
    [StringLength(32)]
    [Unicode(false)]
    public string InventoryAttrValProductAttrValId { get; set; } = null!;
    ...
    [ForeignKey("InventoryAttrValProductAttrValId")]
    [InverseProperty("InventoryAttrVals")]
    public virtual ProductAttr InventoryAttrValProductAttrVal { get; set; } = null!;
}
