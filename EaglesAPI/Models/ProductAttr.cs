...
public partial class ProductAttr
{
    ...
    [Column("PRODUCT_ATTR_REQ_ID")]
    [Precision(1)]
    public bool ProductAttrReqId { get; set; }
    ...
    [InverseProperty("InventoryAttrValProductAttrVal")]
    ...
    [ForeignKey("ProductAttrId")]
    [InverseProperty("ProductAttr")]
    public virtual Product ProductAttrNavigation { get; set; } = null!;
}
